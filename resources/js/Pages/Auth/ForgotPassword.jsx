...
export default function ForgotPassword() {
    ...
    return (
        <div className="grid min-h-screen place-items-center p-4">
            ...
            <form
                onSubmit={(event) => { event.preventDefault(); post('/forgot-password'); }}
            ...
            >
                ...
                <p className="mb-4 text-sm text-muted">Kami kirimkan tautan setel ulang ke email Anda</p>
                ...
                <p className="mt-4 text-center text-xs">
                    <Link href="/login" className="text-accent">Kembali ke halaman masuk</Link>
                </p>
            </form>
        </div>
    );
